...
for n in tqdm(range(0,len(evt_id))):    
    ...
    #             ax.legend() 
                plt.savefig('./Analysis_Data/St_Helens_Figs/_'+event_ID+'psd'+'.png')
                ...
                plt.savefig('./Analysis_Data/St_Helens_Figs/_'+event_ID+'wiggles'+'.png')
    ...
    #                 cbar.set_label('RMS error on location', rotation=270)
                ...
                plt.grid(True)
                plt.savefig('./Analysis_Data/St_Helens_Figs/'+associated_volcano+event_ID+'curves_freq_data'+'.png')
    ...
    #             plt.tight_layout()
    #             plt.savefig('./Analysis_Data/St_Helens_Figs/'+associated_volcano+event_ID +'loc_direction'+'.png',bbox_inches="tight")
