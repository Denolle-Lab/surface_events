...
dem = rio.open(str(name)+'/_w001001.adf') #oregon volcanoes
...
for n in tqdm(range(0,len(evt_id))):    
    ...
    #             ax.legend() 
    #             plt.savefig('./Analysis_Data/Hood_Figs/'+associated_volcano+event_ID+'psd'+'.png')
                ...
                plt.savefig('./Analysis_Data/Hood_Figs_'+event_ID+'wiggles'+'.png')
                ...
                slen = round(volc_grid['Mt_Hood'][2]/10)
    ...
    #                 continue
                ...
                plt.grid(True)
                plt.savefig('./Analysis_Data/Hood_Figs/_'+event_ID+'curves_freq_data'+'.png')
    ...
    #             plt.tight_layout()
    #             plt.savefig('./Analysis_Data/Hood/'+associated_volcano+event_ID +'loc_direction'+'.png',bbox_inches="tight")
                ...
                evt_data.to_csv('~/surface_events/Analysis_Data/Event_Data_Hood.csv', index=False)
                sta_freq.to_csv('~/surface_events/Analysis_Data/Station_frequency_data_Hood.csv', index=False)
    except:
        reject_evts = reject_evts.append({'event_ID':[event_ID]}, ignore_index = True)
        reject_evts.to_csv('~/surface_events/Analysis_Data/Rejects_Hood.csv', index=False)
        continue
