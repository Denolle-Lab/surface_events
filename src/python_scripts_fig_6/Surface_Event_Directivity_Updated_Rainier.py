...
#             bottom, top = r_dem_data_dict[associated_volcano]['bottom'],r_dem_data_dict[associated_volcano]['top']
            ...
            evt_data.to_csv('~/surface_events/Event_Data_Rainier.csv', index=False)
            sta_freq.to_csv('~/surface_events/Station_frequency_data_Rainier.csv', index=False)
    #     except:
